...
- (void)viewDidLoad {
    ...
    UIBarButtonItem *item = [[UIBarButtonItem alloc]initWithTitle:@"发帖" style:UIBarButtonItemStylePlain target:self action:@selector(sendblog)];
...
-(void)setUptables
{
    ...
    self.tableview.header = [MJRefreshNormalHeader headerWithRefreshingBlock:^{
        ...
        [[ExamService shareInstenced]getFirstnewWithUid:model.uid];
    }];
    self.tableview.footer = [MJRefreshAutoFooter footerWithRefreshingBlock:^{
        
        [[ExamService shareInstenced]getMorenewWithUid:model.uid];
    }];
...
-(void)configBlock
{
    [ExamService shareInstenced].getnewsSuccess = ^(id obj){
    ...
    [ExamService shareInstenced].getnewsFailure = ^(id obj){
